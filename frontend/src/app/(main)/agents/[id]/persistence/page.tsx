    ...
    return (
      <div className="max-w-[80rem] mx-auto pb-12 md:pb-0 animate-fade-slide-up">
        <div className="text-center py-20">
          ...
          <Link href="/agents" className="inline-flex items-center px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/80 rounded-xl text-sm font-medium transition-colors">
              Back to Agents
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <Card className="p-4 sm:p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="secondary" className="text-[10px]">{installedMethods.length}</Badge>
          </div>
