              ...
              <div className="bg-card border border-border rounded-xl p-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                    report.cv < 0.15 ? "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300" :
                    report.cv < 0.3 ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300" :
                ...
                {report.suggestion ? (
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                        report.suggestion.confidence === "high" ? "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300" :
