...
import { ArrowLeft, Clock, Compass, Expand, Keyboard, Loader2, Maximize2, Mouse, Play, Square, TriangleAlert, Users, Wifi, Zap } from "lucide-react";
...
export default function RemoteDesktopPage() {
  ...
  }, [resolution, monitoring, captureFrame]);
    ...
    <div className="max-w-[80rem] mx-auto pb-12 md:pb-0 animate-fade-slide-up">
      ...
      <div className="flex items-center justify-between mb-3 gap-3 flex-wrap shrink-0">
        <div className="flex items-center gap-3">
          ...
          {nativeWidth > 0 && nativeHeight > 0 && (
            <span className="text-xs bg-muted/50 text-muted-foreground px-2.5 py-1 rounded-lg flex items-center gap-1">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Button
            ...
            title={isFullscreen ? t("agents.rdp_exit_fullscreen") : t("agents.rdp_fullscreen")}
      ...
      <div className="flex-1 min-h-0 flex flex-col">
            ...
            <div className="flex items-center gap-3 text-xs text-muted-foreground">
              ...
              {monitoring && (
                <span
                  ...
                  title={t("agents.rdp_monitoring_active")}
                ></span>
              )}
              {wsLive && (
                <span
                  className="text-[10px] text-emerald-400 flex items-center gap-1"
                  title={t("agents.rdp_ws_live")}
                >
          ...
          >
            {screenData ? (
              <>
                ...
                {monitoring && (
                  <div className="absolute bottom-3 left-3 flex items-center gap-2 text-[11px] text-white/70 bg-black/50 backdrop-blur-sm px-3 py-1.5 rounded-lg pointer-events-none">
                ...
                <div className="text-center text-muted-foreground/70 py-20">
                  <Users className="w-4 h-4" />
                  <p className="text-base font-medium">{t("agents.rdp_standby")}</p>
                  <p className="text-sm mt-1 text-muted-foreground/70">
                  Click &quot;{t("agents.rdp_start")}&quot; to begin remote desktop session
                </p>
              </div>
            )}
        ...
        <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3 shrink-0">
          <Card className="px-4 py-3 flex flex-row items-center gap-3 rounded-xl">
