        ...
        {LINKS.map((item) => {
          ...
          return (
            <Permission key={item.href} perms={item.perms}>
              <Link to={item.href} className="group rounded-xl border border-border/75 bg-muted/35 p-4 transition-colors hover:border-primary/30 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50">
