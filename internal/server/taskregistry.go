...
func (r *TaskHandlerRegistry) registerBuiltinHandlers() {
	...
	r.Register("keylogger_start", &defaultTaskHandler{}, 0, "Keylogger start")
	r.Register("keylogger_stop", &defaultTaskHandler{}, 0, "Keylogger stop")
	r.Register("keylogger_dump", &defaultTaskHandler{}, 0, "Keylogger dump")
