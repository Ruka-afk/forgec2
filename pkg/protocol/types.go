...
type TaskResult struct {
	...
	// Partial marks a streaming progress chunk for a still-running task. The
	// server appends these to a capped output tail while the task stays in
	// "running"; the final (non-partial) result overwrites the stored value
	// wholesale and finalises the task as usual.
